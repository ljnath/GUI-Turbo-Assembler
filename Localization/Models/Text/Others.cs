...
namespace GUITurboAssembler.Localization.Models.Text
{
    public class Others
    {
        ...
        public string MissingFileTitle { get; set; } = "Missing File";
        public string MissingHelpFileMsg { get; set; } = "The help file cannot be found. Please make sure that the file 'gtasm.chm' exists in this directory.";
