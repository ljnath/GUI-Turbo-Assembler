...
namespace FastColoredTextBoxNS
{
    public partial class ReplaceForm : Form
    {
        ...
        public ReplaceForm(FastColoredTextBox tb, Texts localizedText)
        {
            ...
            btReplace.Text = currentLocalizedText.IDE.Replace;
            btReplaceAll.Text = currentLocalizedText.IDE.ReplaceAll;
            label1.Text = currentLocalizedText.IDE.Find;
            label2.Text = currentLocalizedText.IDE.Replace;

            this.Text = currentLocalizedText.IDE.FindAndReplace;
        ...
        private void btReplaceAll_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //
                tb.Invalidate();
                MessageBox.Show($"{ranges.Count} {currentLocalizedText.IDE.OccuranceReplaced}");
            }
            catch (Exception ex)
            {
                MessageBox.Show(ex.Message);
