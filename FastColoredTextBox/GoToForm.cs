...
namespace FastColoredTextBoxNS
{
    public partial class GoToForm : Form
    {
        ...
        public GoToForm(Texts localizedText)
        {
            ...
            btnCancel.Text = currentLocalizedText.Others.Cancel;
        }
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            this.label.Text = String.Format($"{currentLocalizedText.IDE.LineNumber} (1 - {this.TotalLineCount}):");
        }
